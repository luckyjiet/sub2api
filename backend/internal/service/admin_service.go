...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	singleDayCardMode := input.SingleDayCardMode && subscriptionType == SubscriptionTypeSubscription
	...
	group := &Group{
		...
		SingleDayCardMode:               singleDayCardMode,
...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if input.SingleDayCardMode != nil {
		group.SingleDayCardMode = *input.SingleDayCardMode && group.SubscriptionType == SubscriptionTypeSubscription
	}
