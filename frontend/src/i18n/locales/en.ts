export default {
  ...
  redeem: {
    ...
    codeRule5:
      'Day-card redemption is single-purchase reset; redeem only after quota is used up, or the current quota will be reset immediately.',
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        singleDayCardMode: 'Single-Day Card Mode',
        singleDayCardModeHint:
          'When enabled, each redeem resets quota and validity from redeem time (no remaining-time carryover).',
    ...
    redeem: {
      ...
      validityDays: 'Validity Days',
      validityHint: 'How many days the redeemed subscription stays active',
      singleDayValidityLockedHint: 'Single-day card group: validity is fixed at 1 day',
      singleDayRedeemNotice:
        'Day card is single-purchase reset: redeem only after quota is exhausted, otherwise quota will be reset immediately.',
