export default {
  ...
  redeem: {
    ...
    codeRule5: '日卡为单次重置型，请在额度用完后再兑换，否则会立即重置当前额度。',
    recentActivity: '最近活动',
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        singleDayCardMode: '单日卡模式',
        singleDayCardModeHint: '启用后每次兑换都会重置额度，并从兑换时间重新计算有效期，不累计剩余时长。',
    ...
    redeem: {
      ...
      validityDays: '有效天数',
      validityHint: '兑换后订阅生效的天数',
      singleDayValidityLockedHint: '单日卡分组：有效期固定为 1 天',
      singleDayRedeemNotice: '日卡为单次重置型，请在额度用完后再兑换，否则会立即重置当前额度。',
